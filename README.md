...
- Os agendametnos do prestador no dia devem ser armazenados em cache;
...
- O usuário deve poder listar todos os prestadares de serviõs cadastrados;
...
- Os agendamentos devem estar disponíveis entre 8h às 18h (Primiero às 8h, último às 17h)
